...
export const EVENT_CHAINS: EventChain[] = [
  ...
  // ============================================
  {
    ...
    developing: 'US DEPLOYS CARRIER GROUP TO TAIWAN STRAIT — PENTAGON RAISES DEFCON LEVEL',
    duration: 2,
  ...
  },
  {
    ...
    developing: 'SATELLITE IMAGES SHOW CHINESE NAVAL BUILDUP — UN CALLS EMERGENCY SESSION',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['nasdaq', 'emerging', 'lithium', 'tesla'],
  ...
  // Mexico Nationalization - 3 outcomes
  {
    ...
    developing: 'FOREIGN MINING COMPANIES FILE EMERGENCY INJUNCTIONS — MEXICO DEPLOYS MILITARY TO MINES',
    duration: 2,
    rumorSentiment: 'mixed',
  ...
  // ============================================
  {
    ...
    developing: 'FED GOVERNORS SPLIT ON DIRECTION — MARKETS WHIPSAW ON CONFLICTING SIGNALS',
    duration: 2,
    rumorSentiment: 'mixed',
  ...
  // ============================================
  {
    ...
    developing: 'DOJ SUBPOENAS BINANCE EXECUTIVES — EXCHANGE PAUSES NEW DEPOSITS',
    duration: 2,
    rumorSentiment: 'bearish',
  ...
  // ============================================
  {
    ...
    developing: 'SAUDI-RUSSIA TALKS STALL — DELEGATES SEEN LEAVING HOTEL EARLY',
    duration: 2,
    rumorSentiment: 'mixed',
    sentimentAssets: ['oil'],
  ...
  // Nuclear Fusion Verification - 3 outcomes
  {
    ...
    developing: 'THREE INDEPENDENT LABS BEGIN REPLICATION ATTEMPTS — RESULTS EXPECTED TOMORROW',
    duration: 2,
    rumorSentiment: 'mixed',
  ...
  // ============================================
  {
    ...
    developing: 'STARSHIP FUELED AND ON PAD — WEATHER WINDOW OPENS TOMORROW',
    duration: 2,
    rumorSentiment: 'mixed',
    sentimentAssets: ['nasdaq', 'tesla'],
  ...
  },
  {
    ...
    developing: "LEAKED INTERNAL MEMO: DEEPMIND TESTS 'BEYOND HUMAN BENCHMARKS ON EVERY METRIC'",
    duration: 2,
  ...
  },
  {
    ...
    developing: "CHINESE OFFICIALS VISIT GIGAFACTORY — DELEGATION DESCRIBED AS 'TENSE'",
    duration: 2,
    rumorSentiment: 'mixed',
    sentimentAssets: ['tesla'],
  ...
  },
  {
    ...
    developing: 'CDC DISPATCHES TEAM TO SE ASIA — AIRPORTS SCREEN ARRIVING PASSENGERS',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['nasdaq', 'emerging', 'tesla'],
  ...
  // Dockworkers Strike - 3 outcomes
  {
    ...
    developing: 'SUPPLY CHAIN EXPERTS WARN OF EMPTY SHELVES WITHIN DAYS — WHITE HOUSE MONITORS',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['nasdaq', 'emerging'],
  ...
  // Amazon Strike - 3 outcomes
  {
    ...
    developing: 'AMAZON DELIVERY DELAYS HIT PRIME MEMBERS — REPLACEMENT WORKERS BUSED IN',
    duration: 2,
    rumorSentiment: 'bearish',
    primaryAsset: 'nasdaq',
  ...
  // Suez Canal Permanent Blockade (×5 Oil spike)
  {
    ...
    developing: 'SATELLITE IMAGERY CONFIRMS MILITARY POSITIONS ALONG CANAL — SHIPPING COMPANIES REROUTE',
    duration: 2,
    rumorSentiment: 'bearish',
  ...
  // Global Wealth Tax Proposal (×3 BTC spike)
  {
    ...
    developing: 'G20 FINANCE MINISTERS DEBATE WEALTH TAX — BILLIONAIRES REPORTEDLY MOVING ASSETS OFFSHORE',
    duration: 2,
    rumorSentiment: 'bearish',
  ...
  // 13. Water Wars
  {
    ...
    developing: 'ARIZONA GOVERNOR DECLARES STATE OF EMERGENCY — FARMERS ABANDON 100K ACRES',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['coffee', 'emerging'],
  ...
  // ============================================
  {
    ...
    developing: 'SHIPPING COMPANIES DIVERT TO CAPE HORN — INSURANCE RATES SPIKE 400%',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['oil', 'emerging'],
    primaryAsset: 'oil',
  ...
  // Mass Migration Crisis in Europe
  {
    ...
    developing: 'EU LEADERS DEADLOCKED — BORDER STATES THREATEN SCHENGEN EXIT',
    duration: 2,
    rumorSentiment: 'bearish',
  ...
  // Chile Discovers World's Largest Lithium Deposit
  {
    ...
    developing: 'CHILEAN CONGRESS DEBATES NATIONALIZATION — MINING STOCKS IN FREEFALL',
    duration: 2,
    rumorSentiment: 'mixed',
    sentimentAssets: ['lithium', 'tesla'],
  ...
  // Far Left Sweeps US Midterm Elections
  {
    ...
    developing: 'NEW CONGRESS ANNOUNCES FIRST 100 DAYS AGENDA: WEALTH TAX, GREEN NEW DEAL, CRYPTO BAN',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['nasdaq', 'btc', 'gold'],
  ...
  // BRICS Launches Gold-Backed Reserve Currency
  {
    ...
    developing: '40 NATIONS SIGNAL INTEREST IN BRICS CURRENCY — DOLLAR INDEX PLUMMETS',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['nasdaq', 'gold'],
  ...
  // Saudi Crown Prince Assassinated
  {
    ...
    developing: 'RIVAL PRINCE CLAIMS THRONE — ARAMCO SHARES HALTED — OIL FUTURES SURGE',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['oil', 'gold'],
  ...
  // Turkey Announces NATO Withdrawal
  {
    ...
    developing: 'TURKEY SIGNS DEFENSE PACT WITH RUSSIA — NATO SCRAMBLES TO SECURE BLACK SEA',
    duration: 2,
    rumorSentiment: 'bearish',
    sentimentAssets: ['defense'],
  ...
  // South China Sea Naval Battle
  {
    ...
    developing: 'US CARRIER GROUP DEPLOYED — CHINA WARNS \'ANY INTERVENTION IS ACT OF WAR\'',
    duration: 2,
    rumorSentiment: 'bearish',
  ...
  // Mexican Cartel War Spills Into US
  {
    ...
    developing: 'US DEPLOYS 50,000 TROOPS TO MEXICAN BORDER — MEXICO WARNS OF \'SOVEREIGNTY VIOLATION\'',
    duration: 2,
    rumorSentiment: 'bearish',
  ...
  // Egypt Threatens War Over Ethiopian Dam
  {
    ...
    developing: 'EGYPTIAN JETS SPOTTED NEAR DAM — UN SECURITY COUNCIL EMERGENCY SESSION',
    duration: 2,
    rumorSentiment: 'bearish',
