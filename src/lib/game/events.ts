...
export const EVENTS: MarketEvent[] = [
  ...
  { category: 'fed', headline: "FED CUTS RATES IN EMERGENCY MOVE", effects: { nasdaq: 0.22, btc: 0.18, altcoins: 0.28, emerging: 0.16, tesla: 0.25, gold: -0.03 }, sentiment: 'bullish', sentimentAssets: ['nasdaq', 'btc', 'altcoins', 'emerging', 'tesla'] },
  ...
  { category: 'geopolitical', headline: "SAUDI ARABIA OPENS EMBASSY IN ISRAEL", effects: { oil: -0.08, defense: -0.05, emerging: 0.12 }, sentiment: 'bullish', sentimentAssets: ['emerging'] },
  ...
  { category: 'economic', headline: "FLASH CRASH - DOW DROPS 1000 POINTS", effects: { gold: 0.15, nasdaq: -0.20, tesla: -0.18 }, sentiment: 'bearish', sentimentAssets: ['nasdaq', 'tesla'] },
  { category: 'economic', headline: "HEDGE FUND BLOWS UP - MARGIN CALLS SPREAD", effects: { nasdaq: -0.12, gold: 0.10, btc: -0.08 }, sentiment: 'bearish', sentimentAssets: ['nasdaq', 'btc'] },
  { category: 'economic', headline: "CURRENCY CRISIS HITS MAJOR EMERGING MARKET", effects: { emerging: -0.22, gold: 0.12, btc: 0.08 }, sentiment: 'bearish', sentimentAssets: ['emerging'] },
  ...
  { category: 'tech', headline: "MASSIVE DATA BREACH HITS 500M USERS", effects: { nasdaq: -0.15, btc: 0.1, altcoins: 0.12 }, sentiment: 'bearish', sentimentAssets: ['nasdaq'] },
  ...
  { category: 'tech', headline: "ANTITRUST SETTLEMENT - BIG TECH PAYS $50B FINE", effects: { nasdaq: -0.10 }, sentiment: 'bearish', sentimentAssets: ['nasdaq'] },
  ...
  { category: 'crypto', headline: "MAJOR EXCHANGE FILES BANKRUPTCY", effects: { btc: -0.35, altcoins: -0.5, nasdaq: -0.08 }, sentiment: 'bearish', sentimentAssets: ['btc', 'altcoins'] },
  ...
  { category: 'crypto', headline: "CHINA BANS CRYPTO FOR 47TH TIME", effects: { btc: -0.2, altcoins: -0.3, nasdaq: -0.05 }, sentiment: 'bearish', sentimentAssets: ['btc', 'altcoins'] },
  ...
  { category: 'crypto', headline: "WHALE DUMPS 10,000 BTC", effects: { btc: -0.25, altcoins: -0.35 }, sentiment: 'bearish', sentimentAssets: ['btc', 'altcoins'] },
  { category: 'crypto', headline: "DEFI PROTOCOL HACKED FOR $2B", effects: { btc: -0.15, altcoins: -0.4 }, sentiment: 'bearish', sentimentAssets: ['btc', 'altcoins'] },
  ...
  { category: 'tesla', headline: "TESLA MISSES DELIVERY GUIDANCE BY 20%", effects: { tesla: -0.30, lithium: -0.12, nasdaq: -0.05 }, sentiment: 'bearish', sentimentAssets: ['tesla'] },
  // Robotaxi event removed - covered by tesla_robotaxi chain and tesla_robotaxi_revolution spike
  { category: 'tesla', headline: "TESLA CYBERTRUCK RECALL - BRAKE FAILURE", effects: { tesla: -0.25, nasdaq: -0.05 }, sentiment: 'bearish', sentimentAssets: ['tesla'] },
  ...
  { category: 'tesla', headline: "TESLA FSD CAUSES FATAL ACCIDENT", effects: { tesla: -0.35, nasdaq: -0.08 }, sentiment: 'bearish', sentimentAssets: ['tesla'] },
  { category: 'tesla', headline: "ELON SELLS $5B IN TSLA SHARES", effects: { tesla: -0.20, nasdaq: -0.03 }, sentiment: 'bearish', sentimentAssets: ['tesla'] },
  ...
  { category: 'tesla', headline: "BYD OVERTAKES TESLA IN GLOBAL SALES", effects: { tesla: -0.22, emerging: 0.15, lithium: 0.08 }, sentiment: 'bearish', sentimentAssets: ['tesla'] },
  ...
  { category: 'tesla', headline: "HERTZ CANCELS MASSIVE TESLA ORDER", effects: { tesla: -0.18, nasdaq: -0.03 }, sentiment: 'bearish', sentimentAssets: ['tesla'] },
  ...
  { category: 'biotech', headline: "FDA REJECTS BLOCKBUSTER DRUG", effects: { biotech: -0.35 }, sentiment: 'bearish', sentimentAssets: ['biotech'] },
  ...
  { category: 'biotech', headline: "OZEMPIC CAUSES HEART ATTACKS - MASS RECALL", effects: { biotech: -0.30, nasdaq: -0.08 }, sentiment: 'bearish', sentimentAssets: ['biotech', 'nasdaq'] },
  ...
  { category: 'energy', headline: "MASSIVE OIL FIELD DISCOVERED IN TURKEY", effects: { oil: -0.28, nasdaq: 0.05 }, sentiment: 'bearish', sentimentAssets: ['oil'] },
  ...
  { category: 'energy', headline: "SURPRISE OPEC MEMBER EXITS AGREEMENT", effects: { oil: -0.20 }, sentiment: 'bearish', sentimentAssets: ['oil'] },
  ...
  { category: 'ev', headline: "RIVIAN DECLARES CHAPTER 11", effects: { lithium: -0.25, nasdaq: -0.12, tesla: 0.15 }, sentiment: 'bearish', sentimentAssets: ['lithium', 'nasdaq'] },
  ...
  { category: 'agriculture', headline: "RECORD GLOBAL HARVEST REPORTED", effects: { coffee: -0.18 }, sentiment: 'bullish', sentimentAssets: ['coffee'] },
